...
class RunGrpcClientAppCheckCommand extends Command
{
	...
	{
		$this->setName("cloud_py_api:grpc:client:app:check");
		$this->setDescription("Run GRPC client AppCheck request");
	...
	{
		$this->serverService->testAppCheck($input, $output);
		return 0;
	}
}
